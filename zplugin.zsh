...
-zplg-ice() {
    ...
    local bit
    for bit; do
        [[ "$bit" = (#b)(from|proto|depth|wait|load|unload|if|blockf|svn|pick|nopick|src|bpick|as|ver|silent|lucid|mv|cp|atinit|atload|atpull|atclone|make|nomake|nosvn|service|compile|nocompletions)(*) ]] && ZPLG_ICE[${match[1]}]="${match[2]}"
    done
