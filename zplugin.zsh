...
ZPLGM[PLUGINS_DIR]=${~ZPLGM[PLUGINS_DIR]}   ZPLGM[COMPLETIONS_DIR]=${~ZPLGM[COMPLETIONS_DIR]}
ZPLGM[SNIPPETS_DIR]=${~ZPLGM[SNIPPETS_DIR]} ZPLGM[SERVICES_DIR]=${~ZPLGM[SERVICES_DIR]}
...
ZPLGM[SHADOWING]=inactive   ZPLGM[DTRACE]=0
...
-zplg-load-snippet() {
    ...
    (( ${+ZPLG_ICE[svn]} )) && {
        [[ $url = *(OMZ::|robbyrussell*oh-my-zsh|ohmyzsh/ohmyzsh)* ]] && local ZSH="${ZPLGM[SNIPPETS_DIR]}"
