...
| ZINIT\[APPLICATIONS_DIR\]           | Where macOS `.app` bundles unpacked from `dmg` images get symlinked, e.g. "/Applications". Default: `~/Applications`                                                                                                                                                                                                                                                                                     |
