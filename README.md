...
| ZINIT\[MAN_DIR\]                    | Directory zinit should add to your manpath, plugins can store their manpages there (`atclone"cp -vf myplugin.1 $ZINIT[MAN_DIR]"`) Default: `$ZPFX/man/man1`                                                                             |
