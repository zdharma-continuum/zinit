...
hljs.registerLanguage("bash", function(e) {
    ...
    return {
        ...
        l: /\b-?[a-z\._]+\b/,
        k: {
            "ice-mod": "blockf svn pick as cp mv atpull wait atload silent unload make id -as run -atpull atclone atinit src multisrc depth from",
            command: "load light snippet cuninstall creinstall clist cdisable cenable report lucid nocompile nocompletions reset -prompt",
            zpl: "zplugin",
            ice: "ice",
        },
        c: [{
