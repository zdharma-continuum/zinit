...
if [[ -z $SOURCED && ( ${+terminfo} -eq 1 && -n ${terminfo[colors]} ) || ( ${+termcap} -eq 1 && -n ${termcap[Co]} ) ]]; then
  typeset -HA __zinit_color=(
    annex   $'\e[38;5;153m'         faint   $'\e[38;5;238m'         msg2    $'\e[38;5;172m'      quo     $'\e[1;38;5;33m'
    apo     $'\e[1;38;5;45m'        file    $'\e[3;38;5;117m'       msg3    $'\e[38;5;238m'      quos    $'\e[1;38;5;160m'
    aps     $'\e[38;5;117m'         flag    $'\e[1;3;38;5;79m'      nb      $'\e[22m'            rst     $'\e[0m'
    b       $'\e[1m'                func    $'\e[38;5;219m'         nit     $'\e[23m'            slight  $'\e[38;5;230m'
    b-lhi   $'\e[1m\e[38;5;75m'     glob    $'\e[38;5;227m'         nl      $'\n'                st      $'\e[9m'
    b-warn  $'\e[1;38;5;214m'       happy   $'\e[1m\e[38;5;82m'     note    $'\e[38;5;148m'      tab     $' \t '
    bapo    $'\e[1;38;5;220m'       hi      $'\e[1m\e[38;5;183m'    nst     $'\e[29m'            term    $'\e[38;5;185m'
    baps    $'\e[1;38;5;82m'        ice     $'\e[38;5;39m'          nu      $'\e[24m'            th-bar  $'\e[38;5;82m'
    bar     $'\e[38;5;82m'          id-as   $'\e[4;38;5;220m'       num     $'\e[3;38;5;155m'    time    $'\e[38;5;220m'
    bcmd    $'\e[38;5;220m'         info    $'\e[38;5;82m'          obj     $'\e[38;5;218m'      txt     $'\e[38;5;254m'
    bspc    $'\b'                   info2   $'\e[38;5;227m'         obj2    $'\e[38;5;118m'      u       $'\e[4m'
    cmd     $'\e[38;5;82m'          info3   $'\e[1m\e[38;5;227m'    ok      $'\e[38;5;220m'      u-warn  $'\e[4;38;5;214m'
    data    $'\e[38;5;82m'          it      $'\e[3m'                opt     $'\e[38;5;219m'      uname   $'\e[1;4m\e[35m'
    data2   $'\e[38;5;117m'         keyword $'\e[32m'               p       $'\e[38;5;81m'       uninst  $'\e[38;5;118m'
    dir     $'\e[3;38;5;153m'       lhi     $'\e[38;5;81m'          pkg     $'\e[1;3;38;5;27m'   url     $'\e[38;5;75m'
    ehi     $'\e[1m\e[38;5;210m'    meta    $'\e[38;5;57m'          pname   $'\e[1;4m\e[32m'     var     $'\e[38;5;81m'
    error   $'\e[1m\e[38;5;204m'    meta2   $'\e[38;5;147m'         pre     $'\e[38;5;135m'      version $'\e[3;38;5;87m'
    failure $'\e[38;5;204m'         msg     $'\e[0m'                profile $'\e[38;5;148m'      warn    $'\e[38;5;214m'
  ...
  if [[ ( ${+terminfo} -eq 1 && ${terminfo[colors]} -ge 256 ) || ( ${+termcap} -eq 1 && ${termcap[Co]} -ge 256 ) ]]; then
    __zinit_color+=( pname $'\e[1;4m\e[38;5;39m' uname  $'\e[1;4m\e[38;5;207m' )
  fi
  ZINIT+=(colors '__zinit_color')
fi
