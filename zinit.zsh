...
export ZPFX=${~ZPFX} ZSH_CACHE_DIR="${ZSH_CACHE_DIR:-${XDG_CACHE_HOME:-$HOME/.cache}/zinit}" PMSPEC=0uUpiPsf
...
ZINIT[CUR_PLUGIN]= ZINIT[DTRACE]=0 ZINIT[TMP_SUBST]=inactive
# ]]]
# Parameters - ICE. [[[
